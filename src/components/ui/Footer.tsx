        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              High-quality 3D printed products made in the EU.
              Our products are created with sustainable materials and cutting-edge technology.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/products?category=home" className="text-base text-gray-500 hover:text-gray-900">
                      Home Decor
                    </Link>
                  </li>
                  <li>
                    <Link href="/products?category=gadgets" className="text-base text-gray-500 hover:text-gray-900">
                      Gadgets
                    </Link>
                  </li>
                  <li>
                    <Link href="/products?category=accessories" className="text-base text-gray-500 hover:text-gray-900">
                      Accessories
                    </Link>
                  </li>
                </ul>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/cookie-policy" className="text-base text-gray-500 hover:text-gray-900">
                      Cookie Policy
                    </Link>
                  </li>
                  <li>
